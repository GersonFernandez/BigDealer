 ...
 * @author Gerson
 */
public class HistorrialFactura extends javax.swing.JInternalFrame {

    /**
     * Creates new form HistorrialFactura
     */
    public HistorrialFactura() {
        initComponents();
        cargarCombobox();
        cargar("");
    }
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Factura", "Cliente", "Marca", "Modelo", "Año", "Color", "Fecha Entrada", "Precio Venta"
            }
        ) {
        ...
        jLabel7.setText("HISTORIAL DE FACTURA");
...
private Map mp_cb_filtro;
    ...
    private void cargar(String filtro){
        ...
        String col_name = " fac.id_factura as 'ID Factura',cli.nombre as Nombre, vma.descripcion as Marca, " +
        ...
        String orden =    " fac.id_factura ";

    
        //System.out.println("HistorrialFactura.cargar()"+col_name + tbl_name);
        tabla = Lib.limpiarTabla(tabla);
        if(filtro.trim().equals("")){

            tabla.setModel(Lib.tblCargarInventarioVehiculos((DefaultTableModel)tabla.getModel(),Lib.queryArray(col_name, tbl_name,orden)));

       
        }else{
            tabla.setModel(Lib.tblCargarInventarioVehiculos((DefaultTableModel)tabla.getModel(),Lib.queryArrayW(col_name, tbl_name," UPPER( "+mp_cb_filtro.get(cb_filtro.getSelectedItem())+ " ) LIKE UPPER('"+ filtro + "%')  ORDER BY "+orden)));
        }
    ...
    private void cargarCombobox(){
        ...
        mp_cb_filtro.put("ID", "fac.id_factura");
        mp_cb_filtro.put("nombre", "cli.nombre");
